...
public class SubsystemManipulator extends Subsystem {
    ...
    public void initDefaultCommand() {
    	setDefaultCommand(new ButtonCommandSpin(Direction.FORWARD)); }
    ...
    /** spin me up, scotty */
    public void startSpinning(Direction direction, double speed) {
    	speed *= (direction == Direction.BACKWARD ? -1 : 1);
